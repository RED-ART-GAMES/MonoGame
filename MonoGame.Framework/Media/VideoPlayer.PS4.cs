...
namespace Microsoft.Xna.Framework.Media
{
    public sealed partial class VideoPlayer
    {
        ...
        private void PlatformGetState(ref MediaState result)
        {
            ...
            switch (state)
            {
                case Sce.PlayStation4.Media.VideoPlayerState.Playing:
                    result = MediaState.Playing;
                    break;
                case Sce.PlayStation4.Media.VideoPlayerState.Paused:
        ...
        private Texture2D PlatformGetTexture()
        {
            ...
            {
                // We drew a new frame and broke a bunch of
                // the render state... so mark it dirty.
                _graphicsDevice.PlatformSetDirty();
            }
