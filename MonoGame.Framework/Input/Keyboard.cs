...
namespace Microsoft.Xna.Framework.Input
{
	...
	public static class Keyboard
	{
        ...
        public static KeyboardState GetState(PlayerIndex playerIndex)
		{
            ...
            PS4Keyboard.GetState((int)playerIndex, out keys0, out keys1, out keys2, out keys3, out keys4, out keys5, out keys6, out keys7);
            return new KeyboardState(keys0, keys1, keys2, keys3, keys4, keys5, keys6, keys7);
#else
            return new KeyboardState(_keys);
#endif
		}
