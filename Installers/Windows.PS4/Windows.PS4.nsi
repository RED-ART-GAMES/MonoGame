...
Section "MonoGame Core Components" CoreComponents ;No components page, name is not important
  ...
  File '..\..\ThirdParty\Sony\scePlayStation4\bin\Release\*_stub_weak.a'
...
Section "Visual Studio 2015 Templates" VS2015
  ...
  InstallTemplates:
    ...
    File /r '..\..\ProjectTemplates\VisualStudio2015\PlayStation4.zip'
    GOTO EndTemplates
...
Section "Uninstall"
  ...
  Delete "$DOCUMENTS\Visual Studio 2015\Templates\ProjectTemplates\Visual C#\MonoGame\PlayStation4.zip"
  Delete "$DOCUMENTS\Visual Studio 2017\Templates\ProjectTemplates\Visual C#\MonoGame\PlayStation4.zip"
