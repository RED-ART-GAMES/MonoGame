...
namespace TwoMGFX
{
    public class ShaderInfo
	{
		...
		static public ShaderInfo FromString(string effectSource, string filePath, Options options)
		{
            ...
            ParseTreeTools.WhitespaceNodes(TokenType.OpenBracket, tree.Nodes, ref cleanFile);
            ParseTreeTools.WhitespaceNodes(TokenType.Sampler_State_Expression, tree.Nodes, ref cleanFile);
            ParseTreeTools.WhitespaceNodes(TokenType.CloseBracket, tree.Nodes, ref cleanFile);
