...
namespace BindingGen
{
    class ScePlayStation4 : ILibrary
    {
        public void Setup(Driver driver)
        {
            ...
            options.NoStandardIncludes = false;
            options.WriteOnlyWhenChanged = false;
            ...
            options.Headers.Add(@"Network\TitleSmallStorage.h");
            options.Headers.Add(@"Network\TitleUserStorage.h");
            options.Headers.Add(@"Network\TrophySet.h");
            options.Headers.Add(@"Network\NetCtl.h");
            ...
            options.Headers.Add(@"System\SaveDataDirNameSearch.h");
            ...
            options.Headers.Add(@"System\Rtc.h");
