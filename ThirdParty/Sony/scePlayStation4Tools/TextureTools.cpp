...
// HACKS: Work around to allow this code to compile under managed C++.
namespace sce { namespace TextureTool { namespace Raw {
class VectorFloat;
}}}
#define _SCE_TEXTURETOOL_RAW_SSE_H
#define _SCE_TEXTURETOOL_RAW_VECTOR_H
