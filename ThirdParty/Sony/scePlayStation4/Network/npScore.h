...
class CS_API NpScoreRankings
{
	...
	CS_IGNORE NpScoreRankings(const NpScoreRankings& ) { }
...
public:
	...
	SceNpAccountId GetUserAccountIdAtIndex();
...
class CS_API NpScoreRequest
{
	...
	CS_IGNORE NpScoreRequest();
	CS_IGNORE NpScoreRequest(const NpScoreRequest& ) { }
...
public:
	...
	NpCommunityError RecordData(	SceNpScoreBoardId boardId,
									SceNpScoreValue score,
									const char *data);
...
protected:
	...
	void* GetGameData(		SceNpScoreBoardId boardId,
...
class CS_API NpScoreTitleContext
{
	...
	CS_IGNORE NpScoreTitleContext();
	CS_IGNORE NpScoreTitleContext(const NpScoreTitleContext& ) { }
