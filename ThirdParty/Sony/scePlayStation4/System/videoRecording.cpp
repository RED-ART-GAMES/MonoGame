...
#define API2 1
#define SceVideoRecordingParam SceVideoRecordingParam2
#define sceVideoRecordingParamInit sceVideoRecordingParamInit2
#define sceVideoRecordingQueryMemSize sceVideoRecordingQueryMemSize2
#define sceVideoRecordingOpen sceVideoRecordingOpen2
#endif
...
#if API2
	param.threadPriority = (int32_t)threadPriority;
#else
