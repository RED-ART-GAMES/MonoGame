...
{
	CS_IGNORE ChunkList(const ChunkList&) { } 
...
{
	CS_IGNORE LociResult(const LociResult&) { } 
...
{
	CS_IGNORE ToDoList(const ToDoList&) { } 
...
{
	CS_IGNORE ProgressResult(const ProgressResult&) { } 
