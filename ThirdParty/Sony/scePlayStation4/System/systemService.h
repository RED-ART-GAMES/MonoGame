...
enum class SystemServiceRenderingMode
{
#if SCE_ORBIS_SDK_VERSION >= 0x03508041u
	Base = SCE_SYSTEM_SERVICE_RENDERING_MODE_BASE,
	NeoHighResolution = SCE_SYSTEM_SERVICE_RENDERING_MODE_NEO_HIGH_RESOLUTION,
	NeoEnhancedFullHD = SCE_SYSTEM_SERVICE_RENDERING_MODE_NEO_ENHANCED_FULL_HD,
	NeoFullHD = SCE_SYSTEM_SERVICE_RENDERING_MODE_NEO_FULL_HD,
#else
	Base = 0,
	NeoHighResolution = 1,
	NeoEnhancedFullHD = 2,
...
public:
	...
	static SystemServiceRenderingMode GetRenderingMode();

	static bool IsNeoMode();
};
