		...
		uint32_t &keys7)
{
	...
	keys0 = states[playerIndex].keys0;
	keys1 = states[playerIndex].keys1;
	keys2 = states[playerIndex].keys2;
	keys3 = states[playerIndex].keys3;
	keys4 = states[playerIndex].keys4;
	keys5 = states[playerIndex].keys5;
	keys6 = states[playerIndex].keys6;
	keys7 = states[playerIndex].keys7;
}
