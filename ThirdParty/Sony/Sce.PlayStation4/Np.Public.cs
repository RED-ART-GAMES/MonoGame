...
namespace Sce.PlayStation4.Network
{
    ...
    public partial class Np
    {
        ...
        /// <summary>
        /// Checks online to return the PSN Account ID of the user
        /// </summary>
        /// <param name="userId">The local user ID</param>
        /// <returns>0 if there was an error</returns>
        public static ulong GetAccountId(int userId)
        {
            return _GetAccountId(userId);
        }
        ...
        /// This is now deprecated but still allowed as of TRC 1.7
        /// Use CheckNpAvailabilityA instead
        /// </summary>
        ...
        /// <summary>
        /// Returns the state of the network access
        /// </summary>
        public static NpResult CheckNpAvailabilityA(int userId)
        {
            NpResult result = _CheckNpAvailability(userId);
